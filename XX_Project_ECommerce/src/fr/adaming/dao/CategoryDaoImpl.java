...
public class CategoryDaoImpl implements ICategoryDao {
	...
	public int updateCat(Category cat) {
		String req = "UPDATE Category as cat SET cat.name:=pName, cat.photo:=pPhoto, cat.description:=pDescription WHERE id:=pIdCat ";
		Query query = em.createQuery(req);
	...
	public int deleteCat(Category cat) {
		String req = "DELETE Category as cat WHERE id:=pIdCat";
